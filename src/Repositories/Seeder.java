...
public class Seeder {
    ...
    public static void seederMetodo(){
        ...
        UserRepository.generalArraylist.add(client1);
        //Cliente2
        ...
        UserRepository.generalArraylist.add(client2);
        //Cliente3
        ...
        UserRepository.generalArraylist.add(client3);
        ...
        UserRepository.generalArraylist.add(newAdmin1);
        //Admin2
        ...
        UserRepository.generalArraylist.add(newAdmin2);
    }
}
